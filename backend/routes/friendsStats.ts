...
export default async function friendsStatsRoutes(fastify: FastifyInstance) {
    ...
    fastify.get(
        '/api/stats/friend/:friendId/wins',
        {
    ...
    // 2. Monthly win rate
    fastify.get(
        '/api/stats/friend/:friendId/monthly-wins',
        {
            preHandler: authMiddleware,
        },
        async (req: FastifyRequest, reply: FastifyReply) => {
    ...
    // 3. All-time goals
    fastify.get(
        '/api/stats/friend/:friendId/goals',
        {
            preHandler: authMiddleware,
        },
        async (req: FastifyRequest, reply: FastifyReply) => {
    ...
    // 4. Monthly goals
    fastify.get(
        '/api/stats/friend/:friendId/monthly-goals',
        {
            preHandler: authMiddleware,
        },
        async (req: FastifyRequest, reply: FastifyReply) => {
    ...
    fastify.get(
        '/api/stats/friend/:friendId/trophies',
        {
            preHandler: authMiddleware,
        },
        async (req: FastifyRequest, reply: FastifyReply) => {
