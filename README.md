...
4.  **Configure Environment Variables:**
    ...
    _Ensure `IP_ADDR` matches the host your frontend is served from and is accessible by Docker containers._
...
6.  **Run with Docker:**
    _Make sure Docker and Docker Compose are installed._
    ...
    _Note: If encountering "Path too long" errors on Windows, consider enabling long path support or using `rimraf` for `node_modules` cleanup._
